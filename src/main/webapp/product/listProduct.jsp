...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		...
		<%
			...
			<input type="text" value="<%=searchVO.getSearchKeyword()%>" name="searchKeyword"  
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tr>
		...
		%>
			...
			<td></td>
				<% if ( (userVO != null && userVO.getRole().equals("admin")) || productVO.getProTranCode().equals("0")){ %>		
		...
		<td align="left">
				...
				<% } else if ( productVO.getProTranCode().equals("1")){ %>
					구매완료		
					<% if (menu.equals("manage")){ %>
						<a href="/updateTranCodeByProd.do?prodNo=<%= productVO.getProdNo ()%>&tranCode=2"> [ 관리자 : 배송하기 ] </a>
					<% 	} %>
